...
class Utilisateur(Base):
    ...
    id_utilisateur = Column(String, primary_key=True, index=True, autoincrement=True, unique=True, default=uuid.uuid4())
...
class Activite(Base):
    ...
    id_activite = Column(String, primary_key=True, index=True, autoincrement=True, unique=True, default=uuid.uuid4())
...
class Image(Base):
    ...
    id_image = Column(String, primary_key=True, index=True, autoincrement=True, unique=True, default=uuid.uuid4())
    image_path = Column(String, nullable=False)
    nbre_total_fruit = Column(Integer, nullable=False)
    date_televersement = Column(DateTime, default=datetime.utcnow)

    id_activite = Column(Integer, ForeignKey("activite.id_activite"))
...
class ResultatsAnalyse(Base):
    ...
    id_resultat = Column(String, primary_key=True, index=True, autoincrement=True, unique=True, default=uuid.uuid4())
    nom_fruit = Column(String, nullable=False)
    nbre_fruit = Column(Integer, nullable=False)

    id_image = Column(Integer, ForeignKey("image.id_image"))
